		...
		<ul class="breadcrumb">
  		...
  		<div id="main-content">
		    <ul class="shortcut-buttons-set">
		      	<li><a class="shortcut-button" href="${globalSetting.url}/admin/addArticle"><span> <img src="static/admin/images/icons/pencil_48.png" alt="icon" /><br />
		        	新建文章 </span></a></li>
		      	<li><a class="shortcut-button" href="${globalSetting.url}/admin/listArticle"><span> <img src="static/admin/images/icons/paper_content_pencil_48.png" alt="icon" /><br />
		        	文章管理 </span></a></li>
